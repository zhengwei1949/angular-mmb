...
//     });
// });
var inlanddiscountController = myApp.controller('inlanddiscountController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
    $scope.getInlanddiscount = function() {
        $http({
            method: 'get',
            url: 'http://mmb.ittun.com/api/getinlanddiscount'
        }).success(function(data) {
            ...
            $scope.inlanddiscounts = data.result;
        });
    }
    $scope.getInlanddiscount();
}]);