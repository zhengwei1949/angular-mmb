...
//     }
// })
var gsproductController = myApp.controller('gsproductController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
    $scope.getGsProduct = function() {
        $http({
            ...
            $scope.gsproducts = data.result;
        });
    }
    $scope.getGsProduct();
    $scope.getGsShop = function() {
        $http({
            method: 'get',
            url: 'http://mmb.ittun.com/api/getgsshop'
        }).success(function(data) {
